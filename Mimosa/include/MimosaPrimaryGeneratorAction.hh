...
#ifndef MimosaPrimaryGeneratorActionH
#define MimosaPrimaryGeneratorActionH
...
class MimosaPrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction
{
    public:
        MimosaPrimaryGeneratorAction();
        ~MimosaPrimaryGeneratorAction();
