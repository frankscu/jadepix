...
JadePixDigi::JadePixDigi(int trackId,int chipId,int rowId,int colId,double ADC, double TDC):m_trackId(trackId),m_globalChipId(chipId),m_rowId(rowId),m_colId(colId),m_adc(ADC),m_tdc(TDC),m_IsInHit(false),m_IsInCluster(false){
...
bool JadePixDigi::IsAdjacentTo(JadePixDigi* digi, int size){
