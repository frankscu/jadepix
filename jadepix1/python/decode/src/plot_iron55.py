...
def main(cluster33_fname,cluster55_fname,cluster77_fname):
    ...
    cluster33_cluster_hist = ROOT.TH1F('cluster33 cluster signal','{}^{55}Fe  Cluster Signal',500,0,8000)
    ...
    cluster55_cluster_hist = ROOT.TH1F('cluster55 cluster signal','{}^{55}Fe  Cluster Signal',500,0,8000)
    ...
    cluster77_cluster_hist = ROOT.TH1F('cluster77 cluster signal','{}^{55}Fe  Cluster Signal',500,0,8000)
    ...
    cluster_canvas.SaveAs('../fig/iron50_cluster_compare.gif')


if __name__ == '__main__':
    
    main('../output/cluster33_weak_iron55_thr500.root','../output//cluster55_weak_iron55_thr500.root','../output/cluster77_weak_iron55_thr500.root')
