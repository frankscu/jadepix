...
// $Id$
// 
/// \file JadePixEventActionMessenger.cc
/// \brief Implementation of the JadePixEventActionMessenger class
...
JadePixEventActionMessenger::JadePixEventActionMessenger(JadePixEventAction* eventAction)
 : G4UImessenger(),
...
JadePixEventActionMessenger::~JadePixEventActionMessenger()
{
...
void JadePixEventActionMessenger::SetNewValue(
