...
'''
decode Iron55 source data to cluster 5*5 size
'''
...
#OUTPUT = ROOT.TFile('../output/cluster55_strong_iron55_thr500.root','recreate')
OUTPUT = ROOT.TFile('../output/cluster55_weak_iron55_thr500.root','recreate')
