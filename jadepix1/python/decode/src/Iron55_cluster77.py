...
'''
decode Iron55 source data to cluster 7*7 size
'''
...
#OUTPUT = ROOT.TFile('../output/cluster33_strong_iron77_thr500.root','recreate')
OUTPUT = ROOT.TFile('../output/cluster33_weak_iron77_thr500.root','recreate')
...
if __name__=="__main__":
    ...
    while True:
        ...
        if tmp == 'y':
            ...
            #process_Data(filename='../source_data/Source_CHIPA1_180322155350.df',try_process_number=19280,maxframenumber=maxf)    
