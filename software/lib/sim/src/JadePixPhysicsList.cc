...
//
//
// $Id: JadePixPhysicsList.cc,v 1.27 2009-11-15 14:27:30 maire Exp $
...
JadePixPhysicsList::JadePixPhysicsList():  G4VUserPhysicsList()
{
...
void JadePixPhysicsList::ConstructBosons()
{
  // pseudo-particles
...
void JadePixPhysicsList::ConstructLeptons()
{
  // leptons
  //  e+/-
...
void JadePixPhysicsList::ConstructMesons()
{
  //  mesons
  //    light mesons
...
void JadePixPhysicsList::ConstructBaryons()
{
  //  barions
...
void JadePixPhysicsList::ConstructEM()
{
...
void JadePixPhysicsList::ConstructGeneral()
{
  G4PhysicsListHelper* ph = G4PhysicsListHelper::GetPhysicsListHelper();
