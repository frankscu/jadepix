...
'''
decode Iron55 source data to cluster 3*3 size
'''
...
#OUTPUT = ROOT.TFile('../output/cluster33_strong_iron55_thr500.root','recreate')
OUTPUT = ROOT.TFile('../output/cluster33_weak_iron55_thr500.root','recreate')
